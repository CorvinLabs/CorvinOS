...
- Name: test_performance_accessibility.spec.ts >> Task Graph Component — Performance >> Pan and zoom performance (60 fps)
- Location: tests/e2e/test_performance_accessibility.spec.ts:195:12
