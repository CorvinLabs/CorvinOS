...
- Name: test_interactions.spec.ts >> Task Graph Component — User Interactions >> Filter dropdown: select "error" → only error nodes visible
- Location: tests/e2e/test_interactions.spec.ts:141:12
