...
- Name: test_interactions.spec.ts >> Task Graph Component — User Interactions >> Search/highlight node by ID (input field)
- Location: tests/e2e/test_interactions.spec.ts:245:12
