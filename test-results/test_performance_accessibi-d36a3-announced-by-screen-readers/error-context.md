...
- Name: test_performance_accessibility.spec.ts >> Task Graph Component — Accessibility >> Tooltip text is announced by screen readers
- Location: tests/e2e/test_performance_accessibility.spec.ts:455:12
