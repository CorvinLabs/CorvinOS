...
- Name: test_component_rendering.spec.ts >> Task Graph Component — Rendering >> Reset zoom/pan button returns to default
- Location: tests/e2e/test_component_rendering.spec.ts:244:12
