...
- Name: test_marketplace_ui_phase2.spec.ts >> Marketplace UI Phase 2 >> should show error message if install fails
- Location: tests/e2e/test_marketplace_ui_phase2.spec.ts:240:7
