...
- Name: test_component_rendering.spec.ts >> Task Graph Component — Rendering >> Export button (DOT) generates file
- Location: tests/e2e/test_component_rendering.spec.ts:341:12
