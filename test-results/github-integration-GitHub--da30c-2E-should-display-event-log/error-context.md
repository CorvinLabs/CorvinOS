...
- Name: github-integration.spec.ts >> GitHub Integration E2E >> should display event log
- Location: tests/e2e/github-integration.spec.ts:87:7
...
Locator: locator('text=Sync Events')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Sync Events')
