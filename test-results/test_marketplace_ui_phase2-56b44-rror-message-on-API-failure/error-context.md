...
- Name: test_marketplace_ui_phase2.spec.ts >> Marketplace UI Phase 2 >> should display error message on API failure
- Location: tests/e2e/test_marketplace_ui_phase2.spec.ts:181:7
