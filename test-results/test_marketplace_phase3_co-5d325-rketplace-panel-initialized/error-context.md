...
- Name: test_marketplace_phase3_complete.spec.ts >> Phase 3: Complete Marketplace Flows >> 1. Console Bootstrap >> should load console with marketplace panel initialized
- Location: tests/e2e/test_marketplace_phase3_complete.spec.ts:31:9
