...
- Name: test_marketplace_ui_phase2.spec.ts >> Marketplace UI Phase 2 >> should close modal on X button click
- Location: tests/e2e/test_marketplace_ui_phase2.spec.ts:70:7
