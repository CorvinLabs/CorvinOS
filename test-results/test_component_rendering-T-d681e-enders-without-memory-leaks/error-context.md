...
- Name: test_component_rendering.spec.ts >> Task Graph Component — Rendering >> Large graph renders without memory leaks
- Location: tests/e2e/test_component_rendering.spec.ts:360:12
