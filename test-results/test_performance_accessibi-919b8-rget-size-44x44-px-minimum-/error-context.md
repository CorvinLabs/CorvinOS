...
- Name: test_performance_accessibility.spec.ts >> Task Graph Component — Accessibility >> Sufficient touch target size (44x44 px minimum)
- Location: tests/e2e/test_performance_accessibility.spec.ts:377:12
