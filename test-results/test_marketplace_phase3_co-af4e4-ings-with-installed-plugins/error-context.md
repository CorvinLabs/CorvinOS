...
- Name: test_marketplace_phase3_complete.spec.ts >> Phase 3: Complete Marketplace Flows >> 6. Settings Panel >> should sync settings with installed plugins
- Location: tests/e2e/test_marketplace_phase3_complete.spec.ts:224:9
