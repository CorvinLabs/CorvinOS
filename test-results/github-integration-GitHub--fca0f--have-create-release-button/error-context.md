...
- Name: github-integration.spec.ts >> GitHub Integration E2E >> should have create release button
- Location: tests/e2e/github-integration.spec.ts:154:7
...
Locator: locator('button:has-text("New Release")')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('button:has-text("New Release")')
