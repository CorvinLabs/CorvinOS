...
- Name: test_performance_accessibility.spec.ts >> Task Graph Component — Accessibility >> Focus indicator visible on all interactive elements
- Location: tests/e2e/test_performance_accessibility.spec.ts:425:12
