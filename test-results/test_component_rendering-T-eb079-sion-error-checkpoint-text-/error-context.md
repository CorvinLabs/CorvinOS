...
- Name: test_component_rendering.spec.ts >> Task Graph Component — Rendering >> Node labels visible (decision/error/checkpoint text)
- Location: tests/e2e/test_component_rendering.spec.ts:122:12
