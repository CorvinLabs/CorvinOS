...
- Name: test_performance_accessibility.spec.ts >> Task Graph Component — Accessibility >> Keyboard navigation (Tab) through nodes
- Location: tests/e2e/test_performance_accessibility.spec.ts:263:12
