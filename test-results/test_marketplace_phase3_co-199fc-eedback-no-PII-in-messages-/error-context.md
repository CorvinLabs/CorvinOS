...
- Name: test_marketplace_phase3_complete.spec.ts >> Phase 3: Complete Marketplace Flows >> 2. E2E Discovery + Install Flow >> should handle install with error feedback (no PII in messages)
- Location: tests/e2e/test_marketplace_phase3_complete.spec.ts:71:9
