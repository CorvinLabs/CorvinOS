...
- Name: test_marketplace_ui_phase2.spec.ts >> Marketplace UI Phase 2 >> should reset category filter with All button
- Location: tests/e2e/test_marketplace_ui_phase2.spec.ts:127:7
