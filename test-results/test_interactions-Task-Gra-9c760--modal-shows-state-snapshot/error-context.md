...
- Name: test_interactions.spec.ts >> Task Graph Component — User Interactions >> Click checkpoint node → modal shows state snapshot
- Location: tests/e2e/test_interactions.spec.ts:77:12
