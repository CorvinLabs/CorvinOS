...
- Name: test_component_rendering.spec.ts >> Task Graph Component — Rendering >> Fit-to-screen button centers graph
- Location: tests/e2e/test_component_rendering.spec.ts:214:12
