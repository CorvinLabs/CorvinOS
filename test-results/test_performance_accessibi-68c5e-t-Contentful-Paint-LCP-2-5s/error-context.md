...
- Name: test_performance_accessibility.spec.ts >> Task Graph Component — Performance >> Largest Contentful Paint (LCP) < 2.5s
- Location: tests/e2e/test_performance_accessibility.spec.ts:129:12
