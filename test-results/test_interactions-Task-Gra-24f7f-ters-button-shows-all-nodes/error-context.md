...
- Name: test_interactions.spec.ts >> Task Graph Component — User Interactions >> Reset filters button shows all nodes
- Location: tests/e2e/test_interactions.spec.ts:223:12
