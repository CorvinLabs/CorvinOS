...
- Name: test_marketplace_phase3_complete.spec.ts >> Phase 3: Complete Marketplace Flows >> 1. Console Bootstrap >> should have marketplace routes available (/api/v2/marketplace/*)
- Location: tests/e2e/test_marketplace_phase3_complete.spec.ts:37:9
