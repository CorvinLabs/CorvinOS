...
- Name: test_performance_accessibility.spec.ts >> Task Graph Component — Accessibility >> Screen reader announces node type and status
- Location: tests/e2e/test_performance_accessibility.spec.ts:310:12
