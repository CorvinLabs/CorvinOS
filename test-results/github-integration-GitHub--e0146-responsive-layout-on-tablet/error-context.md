...
- Name: github-integration.spec.ts >> GitHub Integration E2E >> should handle responsive layout on tablet
- Location: tests/e2e/github-integration.spec.ts:198:7
...
Call log:
  ...
  - waiting for locator('h2')
    ...
    - locator resolved to <h2 class="font-serif text-xl">Pick a chat — or start a new one.</h2>
    - unexpected value "Pick a chat — or start a new one."
    8 × locator resolved to <h2 class="mt-4 mb-2 font-serif text-xl font-light tracking-tight first:mt-0">NordTech Sprint #23 — Priorisierter Backlog (85 S…</h2>
