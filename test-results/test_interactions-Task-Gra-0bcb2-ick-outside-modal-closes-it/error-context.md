...
- Name: test_interactions.spec.ts >> Task Graph Component — User Interactions >> Click outside modal closes it
- Location: tests/e2e/test_interactions.spec.ts:377:12
