...
- Name: github-integration.spec.ts >> GitHub Integration E2E >> should have chain verification
- Location: tests/e2e/github-integration.spec.ts:131:7
...
Locator: locator('button:has-text("Verify Chain")')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('button:has-text("Verify Chain")')
