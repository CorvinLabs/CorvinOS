...
- Name: test_component_rendering.spec.ts >> Task Graph Component — Rendering >> Pan works (drag canvas, position changes)
- Location: tests/e2e/test_component_rendering.spec.ts:181:12
