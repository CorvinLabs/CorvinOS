...
- Name: test_interactions.spec.ts >> Task Graph Component — User Interactions >> Click error node → modal opens with error details
- Location: tests/e2e/test_interactions.spec.ts:57:12
