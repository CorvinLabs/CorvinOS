...
- Name: github-integration.spec.ts >> GitHub Integration E2E >> should show version info
- Location: tests/e2e/github-integration.spec.ts:146:7
...
Locator: locator('text=Latest Version')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Latest Version')
