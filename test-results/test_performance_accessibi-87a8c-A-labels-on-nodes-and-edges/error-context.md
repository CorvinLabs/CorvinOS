...
- Name: test_performance_accessibility.spec.ts >> Task Graph Component — Accessibility >> ARIA labels on nodes and edges
- Location: tests/e2e/test_performance_accessibility.spec.ts:284:12
