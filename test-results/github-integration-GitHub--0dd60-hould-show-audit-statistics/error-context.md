...
- Name: github-integration.spec.ts >> GitHub Integration E2E >> should show audit statistics
- Location: tests/e2e/github-integration.spec.ts:123:7
...
Locator:  locator('text=Total Events')
Expected: visible
Received: undefined
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('text=Total Events')
