...
- Name: test_interactions.spec.ts >> Task Graph Component — User Interactions >> Double-click node → drill-down view (subgraph)
- Location: tests/e2e/test_interactions.spec.ts:284:12
