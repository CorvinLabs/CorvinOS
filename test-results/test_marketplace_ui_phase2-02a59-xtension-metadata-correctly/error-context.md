...
- Name: test_marketplace_ui_phase2.spec.ts >> Marketplace UI Phase 2 >> should display extension metadata correctly
- Location: tests/e2e/test_marketplace_ui_phase2.spec.ts:35:7
