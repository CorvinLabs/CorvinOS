...
- Name: test_marketplace_phase3_complete.spec.ts >> Phase 3: Complete Marketplace Flows >> 6. Settings Panel >> should render settings panel before install (if needed)
- Location: tests/e2e/test_marketplace_phase3_complete.spec.ts:203:9
