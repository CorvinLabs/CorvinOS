...
- Name: github-integration.spec.ts >> GitHub Integration E2E >> should allow worker control (start/stop)
- Location: tests/e2e/github-integration.spec.ts:79:7
...
Locator: locator('button:has-text("Start Worker"), button:has-text("Stop Worker")')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('button:has-text("Start Worker"), button:has-text("Stop Worker")')
