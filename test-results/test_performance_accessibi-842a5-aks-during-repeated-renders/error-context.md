...
- Name: test_performance_accessibility.spec.ts >> Task Graph Component — Performance >> No memory leaks during repeated renders
- Location: tests/e2e/test_performance_accessibility.spec.ts:158:12
