...
- Name: test_performance_accessibility.spec.ts >> Task Graph Component — Accessibility >> Color contrast meets WCAG AA standard
- Location: tests/e2e/test_performance_accessibility.spec.ts:345:12
