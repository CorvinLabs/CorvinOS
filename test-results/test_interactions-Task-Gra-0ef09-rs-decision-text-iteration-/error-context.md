...
- Name: test_interactions.spec.ts >> Task Graph Component — User Interactions >> Click decision node → tooltip appears (decision text, iteration)
- Location: tests/e2e/test_interactions.spec.ts:17:12
