...
- Name: github-integration.spec.ts >> GitHub Integration E2E >> should have webhook registration form
- Location: tests/e2e/github-integration.spec.ts:103:7
...
Locator: locator('input[placeholder*="ghp_"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('input[placeholder*="ghp_"]')
...
- paragraph: The address /app/settings/github/webhooks doesn't exist in the console. This may be a broken link or a typo.
- button "Go back":
  - img
  - text: Go back
- link "Home":
