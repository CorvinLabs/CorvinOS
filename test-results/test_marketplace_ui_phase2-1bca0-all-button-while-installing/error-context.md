...
- Name: test_marketplace_ui_phase2.spec.ts >> Marketplace UI Phase 2 >> should disable install button while installing
- Location: tests/e2e/test_marketplace_ui_phase2.spec.ts:271:7
