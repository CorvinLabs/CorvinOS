...
- Name: test_interactions.spec.ts >> Task Graph Component — User Interactions >> Breadcrumb navigation: go back to full graph
- Location: tests/e2e/test_interactions.spec.ts:312:12
