...
- Name: test_interactions.spec.ts >> Task Graph Component — User Interactions >> Filter dropdown: "All" shows all nodes
- Location: tests/e2e/test_interactions.spec.ts:168:12
