...
- Name: test_marketplace_ui_phase2.spec.ts >> Marketplace UI Phase 2 >> should display no results message when no extensions match filter
- Location: tests/e2e/test_marketplace_ui_phase2.spec.ts:149:7
