...
- Name: test_performance_accessibility.spec.ts >> Task Graph Component — Accessibility >> ARIA live region for status updates
- Location: tests/e2e/test_performance_accessibility.spec.ts:329:12
