...
- Name: test_component_rendering.spec.ts >> Task Graph Component — Rendering >> Color coding correct (success, error, warning, active)
- Location: tests/e2e/test_component_rendering.spec.ts:98:12
