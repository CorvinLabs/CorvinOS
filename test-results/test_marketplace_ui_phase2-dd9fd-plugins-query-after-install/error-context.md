...
- Name: test_marketplace_ui_phase2.spec.ts >> Marketplace UI Phase 2 >> should invalidate plugins query after install
- Location: tests/e2e/test_marketplace_ui_phase2.spec.ts:337:7
    ...
    - main [ref=f1e232]:
      - generic [ref=f1e233]:
        - main [ref=f1e234]:
          ...
          - generic [ref=f1e273]:
            - button "Claude Code" [ref=f1e274] [cursor=pointer]
            - button "auto" [ref=f1e277] [cursor=pointer]
            - button "Voice on" [ref=f1e280] [cursor=pointer]
            - generic [ref=f1e285]: type / for commands
          - generic [ref=f1e287]:
            - button "Attach files" [ref=f1e288]
            - generic [ref=f1e289]:
              - textbox "Message Corvin… (hold Space to speak)" [ref=f1e291]
              - generic [ref=f1e292]:
                - button "Attach files (CSV, PDF, images, …)" [ref=f1e293] [cursor=pointer]
                - button "Start recording (or hold Space)" [ref=f1e294] [cursor=pointer]
                - button "Send (Enter · Shift+Enter for newline)" [disabled]
        - complementary [ref=f1e295]:
          - generic [ref=f1e296]:
            - generic [ref=f1e297]: Chats
            - button "New" [ref=f1e298] [cursor=pointer]
          - generic [ref=f1e299]:
            - generic [ref=f1e300]:
              - button "NordTech Solutions GmbH — KI-Kommandozentrale 1 turn · Sep 06, 2026, 02:46 AM" [ref=f1e301] [cursor=pointer]:
                - generic [ref=f1e302]: NordTech Solutions GmbH — KI-Kommandozentrale
                - generic [ref=f1e304]:
                  - generic [ref=f1e305]: 1 turn
                  - generic [ref=f1e306]: ·
                  - generic [ref=f1e307]: Sep 06, 2026, 02:46 AM
              - button "Rename session" [ref=f1e308] [cursor=pointer]
              - button "Delete session" [ref=f1e312] [cursor=pointer]
            - generic [ref=f1e316]:
              - button "NordTech Solutions GmbH — KI-Kommandozentrale 6 turns · Sep 06, 2026, 02:27 AM" [ref=f1e317] [cursor=pointer]:
                - generic [ref=f1e318]: NordTech Solutions GmbH — KI-Kommandozentrale
                - generic [ref=f1e320]:
                  - generic [ref=f1e321]: 6 turns
                  - generic [ref=f1e322]: ·
                  - generic [ref=f1e323]: Sep 06, 2026, 02:27 AM
              - button "Rename session" [ref=f1e324] [cursor=pointer]
              - button "Delete session" [ref=f1e328] [cursor=pointer]
            - generic [ref=f1e332]:
              - button "New Chat 0 turns · Sep 06, 2026, 02:23 AM" [ref=f1e333] [cursor=pointer]:
                - generic [ref=f1e334]: New Chat
                - generic [ref=f1e336]:
                  - generic [ref=f1e337]: 0 turns
                  - generic [ref=f1e338]: ·
                  - generic [ref=f1e339]: Sep 06, 2026, 02:23 AM
              - button "Rename session" [ref=f1e340] [cursor=pointer]
              - button "Delete session" [ref=f1e344] [cursor=pointer]
            - generic [ref=f1e348]:
              - button "New Chat 0 turns · Sep 06, 2026, 02:23 AM" [ref=f1e349] [cursor=pointer]:
                - generic [ref=f1e350]: New Chat
                - generic [ref=f1e352]:
                  - generic [ref=f1e353]: 0 turns
                  - generic [ref=f1e354]: ·
                  - generic [ref=f1e355]: Sep 06, 2026, 02:23 AM
              - button "Rename session" [ref=f1e356] [cursor=pointer]
              - button "Delete session" [ref=f1e360] [cursor=pointer]
            - generic [ref=f1e364]:
              - button "NordTech — Task Engine E2E 0 turns · Sep 06, 2026, 02:22 AM" [ref=f1e365] [cursor=pointer]:
                - generic [ref=f1e366]: NordTech — Task Engine E2E
                - generic [ref=f1e368]:
                  - generic [ref=f1e369]: 0 turns
                  - generic [ref=f1e370]: ·
                  - generic [ref=f1e371]: Sep 06, 2026, 02:22 AM
              - button "Rename session" [ref=f1e372] [cursor=pointer]
              - button "Delete session" [ref=f1e376] [cursor=pointer]
            - generic [ref=f1e380]:
              - button "mach mal eine tiefgehende… 2 turns · Aug 30, 2026, 11:28 AM" [ref=f1e381] [cursor=pointer]:
                - generic [ref=f1e382]: mach mal eine tiefgehende…
                - generic [ref=f1e384]:
                  - generic [ref=f1e385]: 2 turns
                  - generic [ref=f1e386]: ·
                  - generic [ref=f1e387]: Aug 30, 2026, 11:28 AM
              - button "Rename session" [ref=f1e388] [cursor=pointer]
              - button "Delete session" [ref=f1e392] [cursor=pointer]
            - generic [ref=f1e396]:
              - button "ich bekomme ständig diese… 1 turn · Aug 30, 2026, 09:42 AM" [ref=f1e397] [cursor=pointer]:
                - generic [ref=f1e398]: ich bekomme ständig diese…
                - generic [ref=f1e400]:
                  - generic [ref=f1e401]: 1 turn
                  - generic [ref=f1e402]: ·
                  - generic [ref=f1e403]: Aug 30, 2026, 09:42 AM
              - button "Rename session" [ref=f1e404] [cursor=pointer]
              - button "Delete session" [ref=f1e408] [cursor=pointer]
            - generic [ref=f1e412]:
              - button "das neue frontend wird… 1 turn · Aug 26, 2026, 04:27 PM" [ref=f1e413] [cursor=pointer]:
                - generic [ref=f1e414]: das neue frontend wird…
                - generic [ref=f1e416]:
                  - generic [ref=f1e417]: 1 turn
                  - generic [ref=f1e418]: ·
                  - generic [ref=f1e419]: Aug 26, 2026, 04:27 PM
              - button "Rename session" [ref=f1e420] [cursor=pointer]
              - button "Delete session" [ref=f1e424] [cursor=pointer]
            - generic [ref=f1e428]:
              - button "räume das repo auf… 1 turn · Aug 25, 2026, 01:09 AM" [ref=f1e429] [cursor=pointer]:
                - generic [ref=f1e430]: räume das repo auf…
                - generic [ref=f1e432]:
                  - generic [ref=f1e433]: 1 turn
                  - generic [ref=f1e434]: ·
                  - generic [ref=f1e435]: Aug 25, 2026, 01:09 AM
              - button "Rename session" [ref=f1e436] [cursor=pointer]
              - button "Delete session" [ref=f1e440] [cursor=pointer]
            - generic [ref=f1e444]:
              - button "nutze diesen skill assistant.corvin_end_to_end_ldd… 1 turn · Aug 25, 2026, 01:05 AM" [ref=f1e445] [cursor=pointer]:
                - generic [ref=f1e446]: nutze diesen skill assistant.corvin_end_to_end_ldd…
                - generic [ref=f1e448]:
                  - generic [ref=f1e449]: 1 turn
                  - generic [ref=f1e450]: ·
                  - generic [ref=f1e451]: Aug 25, 2026, 01:05 AM
              - button "Rename session" [ref=f1e452] [cursor=pointer]
              - button "Delete session" [ref=f1e456] [cursor=pointer]
            - generic [ref=f1e460]:
              - button "nutze den skill assistant.corvinos_panel_design… 3 turns · Aug 25, 2026, 12:35 AM" [ref=f1e461] [cursor=pointer]:
                - generic [ref=f1e462]: nutze den skill assistant.corvinos_panel_design…
                - generic [ref=f1e464]:
                  - generic [ref=f1e465]: 3 turns
                  - generic [ref=f1e466]: ·
                  - generic [ref=f1e467]: Aug 25, 2026, 12:35 AM
              - button "Rename session" [ref=f1e468] [cursor=pointer]
              - button "Delete session" [ref=f1e472] [cursor=pointer]
            - generic [ref=f1e476]:
              - button "es gibt eine neue… 3 turns · Aug 24, 2026, 10:45 PM" [ref=f1e477] [cursor=pointer]:
                - generic [ref=f1e478]: es gibt eine neue…
                - generic [ref=f1e480]:
                  - generic [ref=f1e481]: 3 turns
                  - generic [ref=f1e482]: ·
                  - generic [ref=f1e483]: Aug 24, 2026, 10:45 PM
              - button "Rename session" [ref=f1e484] [cursor=pointer]
              - button "Delete session" [ref=f1e488] [cursor=pointer]
            - generic [ref=f1e492]:
              - button "erzeuge in http://127.0.0.1:8765/console/app/skills mit… 6 turns · Aug 20, 2026, 12:41 PM" [ref=f1e493] [cursor=pointer]:
                - generic [ref=f1e494]: erzeuge in http://127.0.0.1:8765/console/app/skills mit…
                - generic [ref=f1e496]:
                  - generic [ref=f1e497]: 6 turns
                  - generic [ref=f1e498]: ·
                  - generic [ref=f1e499]: Aug 20, 2026, 12:41 PM
              - button "Rename session" [ref=f1e500] [cursor=pointer]
              - button "Delete session" [ref=f1e504] [cursor=pointer]
          - generic [ref=f1e508]: Chat sessions are scoped to this browser. Switch sessions using the list above.
```
