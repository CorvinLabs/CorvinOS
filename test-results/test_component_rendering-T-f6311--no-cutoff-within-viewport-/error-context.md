...
- Name: test_component_rendering.spec.ts >> Task Graph Component — Rendering >> All nodes visible (no cutoff, within viewport)
- Location: tests/e2e/test_component_rendering.spec.ts:51:12
