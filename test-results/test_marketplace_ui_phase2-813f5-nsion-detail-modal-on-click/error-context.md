...
- Name: test_marketplace_ui_phase2.spec.ts >> Marketplace UI Phase 2 >> should open extension detail modal on click
- Location: tests/e2e/test_marketplace_ui_phase2.spec.ts:53:7
