...
- Name: test_interactions.spec.ts >> Task Graph Component — User Interactions >> Tooltip disappears on mouseleave
- Location: tests/e2e/test_interactions.spec.ts:37:12
