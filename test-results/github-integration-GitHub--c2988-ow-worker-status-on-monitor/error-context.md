...
- Name: github-integration.spec.ts >> GitHub Integration E2E >> should show worker status on monitor
- Location: tests/e2e/github-integration.spec.ts:71:7
...
Call log:
  ...
  - waiting for locator('text=Status')
