...
- Name: test_interactions.spec.ts >> Task Graph Component — User Interactions >> Highlighted node has different styling
- Location: tests/e2e/test_interactions.spec.ts:263:12
