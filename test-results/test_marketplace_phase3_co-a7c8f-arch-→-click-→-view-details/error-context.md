...
- Name: test_marketplace_phase3_complete.spec.ts >> Phase 3: Complete Marketplace Flows >> 2. E2E Discovery + Install Flow >> should discover plugins: browse → search → click → view details
- Location: tests/e2e/test_marketplace_phase3_complete.spec.ts:49:9
