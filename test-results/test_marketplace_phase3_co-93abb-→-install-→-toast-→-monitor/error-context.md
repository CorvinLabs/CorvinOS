...
- Name: test_marketplace_phase3_complete.spec.ts >> Phase 3: Complete Marketplace Flows >> Full User Journey >> should complete: discover → search → preview → install → toast → monitor
- Location: tests/e2e/test_marketplace_phase3_complete.spec.ts:245:9
