...
- Name: test_component_rendering.spec.ts >> Task Graph Component — Rendering >> Export button (SVG) generates file
- Location: tests/e2e/test_component_rendering.spec.ts:321:12
