...
- Name: test_interactions.spec.ts >> Task Graph Component — User Interactions >> Filter dropdown: select "decision" → only decision nodes
- Location: tests/e2e/test_interactions.spec.ts:112:12
