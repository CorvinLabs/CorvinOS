...
def judge_loss_sync(
    ...
    *,
    ...
    cmd = [
        # R4: whole-payload guard - the judge prompt interleaves two model
        # answers over user text. POSITIONAL argv. Reply contract unaffected:
        # the `{"equivalence": N}` line is parsed from stdout.
