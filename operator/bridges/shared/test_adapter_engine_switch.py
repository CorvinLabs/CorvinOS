...
_FAKE_OPENCODE = (
    ...
    "# event shape (step_start + text + EOF). Since e4dec5c (Windows\n"
    "# command-line-length fix) OpenCodeEngine.spawn() omits the\n"
    "# [message..] positional and writes the prompt to stdin instead;\n"
    "# mirror that here, with the historical argv[-1] form as fallback\n"
    "# so the shim understands both spawn shapes.\n"
