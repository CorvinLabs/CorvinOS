...
_METAPHER_SYSTEM_DE = (
    ...
    "wird BEREITS vorgelesen — du sollst ihn weder echoen noch verändern.\n"
    "\n"
    "DEINE AUFGABE: Schreibe 1–2 Sätze als Metapher, die das Kernthema auf etwas "
    "aus dem Alltag überträgt — mit subtiler Ironie oder unerwarttem Vergleich. "
    "Der Hörer soll innerlich nicken und lächeln ('Ah ja, genau so könnte man "
    "es auch sehen'), nicht lachen. Diese Sätze werden direkt nach dem Input "
    "vorgelesen.\n"
    "\n"
    ...
    "\n"
    "REGELN — load-bearing:\n"
    "  1. Antworte NUR mit der Metapher — kein Echo des Inputs.\n"
    "  2. Beginne IMMER mit einem der vier Marker oben.\n"
    "  3. Maximal zwei Sätze, prägnant, gesprochen (keine Code-Tokens, keine Markdown).\n"
    "  4. Kern-Technik: Wortspiel, unerwarteter Vergleich, oder subtile Ironie.\n"
    "     Beispiele:\n"
    "     • Wortspiel: 'Das ist wie ein Schloss wechseln, aber der Schlüsselbund passt noch.'\n"
    "     • Unerwarteter Vergleich: 'Das ist wie eine Katze auf der Tastatur — funktioniert zufällig.'\n"
    "     • Subtile Ironie: 'Kurz gesagt, von hoffentlich-funktioniert zu ich-hätte-fast-Vertrauen.'\n"
    "  5. Die Ironie muss zur technischen Aussage passen — nie absurd oder ablenkend.\n"
    "  6. Kein neues Wissen — nur Analogie zu dem, was bereits im Input gesagt wurde.\n"
    "  7. Antworte NUR mit leerem String für reine Grüße ('Hallo', 'OK') — bei jeder "
    "inhaltlichen Aussage, auch technisch, erzeuge eine Metapher."
)
...
_METAPHER_SYSTEM_EN = (
    ...
    "ALREADY being read aloud — do not echo or modify it.\n"
    "\n"
    "YOUR TASK: write 1–2 sentences as a metaphor that maps the core topic "
    "onto everyday life — with subtle irony or an unexpected comparison. "
    "The listener should nod and smile internally ('Ah, that's one way to see it'), "
    "not laugh. These sentences will be read aloud AFTER the input.\n"
    "\n"
    ...
    "\n"
    "RULES — load-bearing:\n"
    "  1. Reply with the metaphor ONLY — no echo of the input.\n"
    "  2. Always start with one of the four markers above.\n"
    "  3. Two sentences max, spoken language (no code tokens, no markdown).\n"
    "  4. Core technique: wordplay, unexpected comparison, or subtle irony.\n"
    "     Examples:\n"
    "     • Wordplay: 'Like changing the lock, but the keyring still fits.'\n"
    "     • Unexpected: 'Like a cat on the keyboard — it works by accident.'\n"
    "     • Subtle irony: 'Basically, we moved from hopefully-it-works to I-almost-trust-this.'\n"
    "  5. Irony must fit the technical statement — never absurd or distracting.\n"
    "  6. No new information — just an analogy for what the input already said.\n"
    "  7. Reply with empty string ONLY for greetings ('Hi', 'OK') — for any "
    "substantive statement, even technical, always produce a metaphor."
)

_METAPHER_MARKERS = (
    "Bildlich gesagt,", "Mit anderen Worten,", "Wenn man so will,", "Übersetzt ins Menschliche,",
