...
```bash
ls /home/shumway/projects/Corvin-ADR/decisions/ | grep -E '^[0-9]{4}' | sort | tail -1
```

Add 1, zero-pad to 4 digits (e.g. `0068`).

**Step 2** — Write to `/home/shumway/projects/Corvin-ADR/decisions/XXXX-short-kebab-title.md`:
