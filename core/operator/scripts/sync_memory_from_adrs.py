...
Usage:
  python3 corvin_operator/scripts/sync_memory_from_adrs.py [--dry-run] [--commit]
...
architectural decisions. Do NOT edit manually — run `python3 corvin_operator/scripts/sync_memory_from_adrs.py --commit`
to regenerate.
...
Generated by: `corvin_operator/scripts/sync_memory_from_adrs.py`
