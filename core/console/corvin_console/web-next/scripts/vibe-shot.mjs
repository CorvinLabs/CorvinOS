          ...
          trace: {
            ...
            stages: [
              { stage: "memory", status: "ok", confidence_tier: "medium",
                sources: ["m:plugin-registry"], duration_ms: 95,
