...
export function ThemeToggle({ className }: { className?: string }) {
  ...
  const handleToggle = () => { try { localStorage.setItem("corvin-dark-default-v2", "1"); } catch { /* storage blocked (private mode) — the toggle itself still works */ } setTheme(next[theme]); };
