/**
 * Table UI components — simple, responsive table with zebra striping and hover effects.
 * Built on HTML table elements + Tailwind CSS.
 */
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-10 px-2 text-left align-middle font-semibold text-gray-700 dark:text-gray-300 [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
