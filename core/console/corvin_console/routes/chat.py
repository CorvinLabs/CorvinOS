    ...
    try:
        while True:
            ...
            if mtype == "user":
                ...
                # own tool-use reasoning in the normal turn below — exactly like
                # any other tool — so a message mentioning "website"/"login"/a
                # domain no longer risks losing the whole turn to a browser
                # subprocess (Phase 1 shipped the tool; this removes the
                # classifier that used to hijack the turn in front of it).
